...
#define MTIM_MODE_NORMAL							0
#define MTIM_MODE_PHASECORRECTPWM_8BIT				1
#define MTIM_MODE_PHASECORRECTPWM_9BIT				2
#define MTIM_MODE_PHASECORRECTPWM_10BIT				3
#define MTIM_MODE_CTC_OUTPUT						4
#define MTIM_MODE_FASTPWM_8BIT						5
#define MTIM_MODE_FASTPWM_9BIT						6
#define MTIM_MODE_FASTPWM_10BIT						7
#define MTIM_MODE_PHASEFREQCORRECTPWM_INPUT			8
#define MTIM_MODE_PHASEFREQCORRECTPWM_OUTPUT		9
#define MTIM_MODE_PHASECORRECTPWM_INPUT	    		10
#define MTIM_MODE_PHASECORRECTPWM_OUTPUT    		11
#define MTIM_MODE_CTC_INPUT							12
#define MTIM_MODE_FASTPWM_INPUT						14
#define MTIM_MODE_FASTPWM_OUTPUT					15
